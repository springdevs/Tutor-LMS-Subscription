...
Plugin URI: https://wordpress.org/plugins/tutor-lms-subscription
Description: Tutor LMS support to our subscription module
Version: 1.0.0
Author: SpringDevs
Author URI: https://springdevs.com/
License: GPLv2
License URI: https://www.gnu.org/licenses/gpl-2.0.html
Text Domain: sdevs_tls
...
final class Tutor_subscrpt
{
    ...
    {
        load_plugin_textdomain('sdevs_tls', false, dirname(plugin_basename(__FILE__)) . '/languages/');
    }
